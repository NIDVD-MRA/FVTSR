...
# 提取 Label_Start_End_Slope 和 BiGRU_Start_End_Slope 列数据
label_slope = df['Label_Start_End_Slope']
bigru_slope = df['BiGRU_Start_End_Slope']
...
plt.ylabel('BiGRU_Start_End_Slope')
plt.title('Scatter Plot of Label_Start_End_Slope vs BiGRU_Start_End_Slope')
plt.grid(True)
